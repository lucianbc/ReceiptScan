# University of Bucharest Markdown Thesis

This is based on [Tom Pollard's](https://github.com/tompollard) work, adapted for my specific use case.

From the [original repository](https://github.com/tompollard/phd_thesis_markdown):
...
1. Edit the files in the 'source' directory, then goto step 4.  
